...
autocmd MyAutoCmd FileType *    setlocal iskeyword+=-
...
autocmd MyAutoCmd VimEnter,WinEnter,Colorscheme * highlight IdeographicSpace cterm=underline ctermfg=lightblue gui=underline guifg=lightblue
